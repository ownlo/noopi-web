...
export const httpApi: NoopiApi = {
  ...
  getRoomState: id => request(`/rooms/${id}/state`), getGames: () => request('/games'), getCategories: () => request('/games/liar/categories'),
  ...
  finishAndChoose: async () => { throw { code: 'NOT_IMPLEMENTED', message: 'Backend 연결 시 종료 후 흐름 API 결정이 필요합니다.' } },
